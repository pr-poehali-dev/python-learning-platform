...
import { courses, lessons, quizQuestions, Section } from "@/components/data";
...
export default function SectionLessons({ activeSection, completedLessons, markLessonDone, setActiveSection }: Props) {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-2">Python с нуля — читай, разбирай, переходи дальше</p>
      </div>
